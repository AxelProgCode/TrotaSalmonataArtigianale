...
const products = [
    ...
    { id: '7', name: 'Cubetti per Sugo', sheetColumn: 'H', img: 'img/cubetti-sugo.jpeg', desc: 'Trito precotto (si consigliano 2 cubetti ogni etto di pasta).', price: '0,50/pz', soldOut: false }
];
