...
const products = [
    ...
    { id: '7', name: 'Cubetti Surgelati per Sugo', sheetColumn: 'H', img: 'img/cubetti-sugo.jpeg', desc: 'Trito precotto in cubetti (si consigliano 2 cubetti ogni etto di pasta).', price: '0,50/pz', soldOut: false }
];
